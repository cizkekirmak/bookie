...
<form id="bulkDeleteForm" action="{{ route('profile.books.bulkRemove') }}" method="POST" onsubmit="return confirm(@json(__('Are you sure you want to remove the selected books?')));" style="margin: 0; display: flex; flex-direction: column; height: 100%; width: 100%; flex: 1; min-height: 0;">
    ...
    <div style="display: flex; justify-content: flex-end; margin-bottom: 6px;">
        <button type="submit" id="btnBulkDelete" style="display: none; background: #dd9945; color: #663b04; border: none; padding: 5px 12px; border-radius: 12px; font-family: 'Unkempt', cursive; font-size: 13px; font-weight: bold; cursor: pointer; box-shadow: 0 2px 6px rgba(217,56,56,0.25);">
